'use client';
import { DEFAULT_ELITE_CONFIG, getConsecutiveHitMultiplier } from '@/lib/core/scoring';
import { EliteConfig, GameMode } from '@/lib/core/types';
...
export default function MultiplierBadge({
  ...
  const multipliers = eliteConfig?.multipliers ?? DEFAULT_ELITE_CONFIG.multipliers;
